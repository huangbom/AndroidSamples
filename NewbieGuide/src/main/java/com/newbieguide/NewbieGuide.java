...
public class NewbieGuide {
    ...
    static final int TYPE_ROUDRECT = HoleBean.TYPE_ROUDRECT;
    ...
    public NewbieGuide addRelativeView(View target,View view,float xPercent,float yPercent){
